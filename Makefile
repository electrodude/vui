...
libvui.a:	vui.o statemachine.o gc.o stack.o string.o utf8.o
		$(AR) $@ $^
		$(RANLIB) $@
...
depend:		
		$(CC) $(CCFLAGS) -MM {vuitest,graphviz,vui,statemachine,gc,stack,string,utf8}.c

.PHONY:		all clean

# output of `make depend`

vuitest.o: vuitest.c vui.h string.h statemachine.h stack.h gc.h graphviz.h
