 ...
 *
 */
typedef struct vui_state* (*vui_transition_callback)(struct vui_state* currstate, int c, int act, void* data);
...
static inline vui_state* vui_next(vui_state* currstate, int c, int act)
{
